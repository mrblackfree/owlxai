...
use Ai\Infrastructure\Services\EnhancedSlide;
...
class AiModuleBootstrapper implements BootstrapperInterface
{
    ...
    private function setupAiServiceFactory(): void
    {
        ...
        // Register SlideExporter service
        $this->app->set(
            EnhancedSlide\SlideExporter::class,
            fn() => new EnhancedSlide\SlideExporter(
                $this->container->get('config.dirs.uploads')
            )
        );
