...
use Billing\Infrastructure\Payments\Gateways\Payoneer\Payoneer;
...
#[Route(path: '/billing/checkout/payoneer/success', method: RequestMethod::GET)]
class PayoneerSuccessRequestHandler extends BillingView implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        // Payoneer 필수 파라미터 확인
        if (!isset($params['charge_id']) || !isset($params['order_id'])) {
        ...
        try {
            ...
            // Payoneer 게이트웨이 가져오기
            $gateway = $this->factory->create(Payoneer::LOOKUP_KEY);
